...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
		...
		values (500,3080,'Reporte de Teleconsultas sin contestar',50,'?r=telesinc',1);
		go
		SET IDENTITY_INSERT menu OFF;
		go

		insert into menud (MENUID,USUARIO,ACCESO) values (500,'AGALVIS',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (500,'VBRUN',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (500,'SHERRERA',1);
    */
?>

<div class="starter-template">
    <h3>Reporte de Teleconsultas sin contestar</h3>
</div>
<form name="form1" action="telesinc_rpt.php" method="POST">
    <div class="row">
        <div class="col">
