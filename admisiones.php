...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
		...
		values (580,3160,'Reporte de Admisiones',40,'?r=admisiones',1);
		go
		SET IDENTITY_INSERT menu OFF;
		go

		insert into menud (MENUID,USUARIO,ACCESO) values (580,'AGALVIS',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (580,'VBRUN',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (580,'SHERRERA',1);
    */

?>
<div class="starter-template">
    <h3>Reporte de Admisiones</h3>
</div>
<form name="form1" action="admisiones_rpt.php" method="POST">
    <div class="row">
        <div class="col">
