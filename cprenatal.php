...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
        ...
        values (480,3060,'Atención por Control Prenatal',20,'?r=cprenatal',1);
        go
        SET IDENTITY_INSERT menu OFF;
        go

        insert into menud (MENUID,USUARIO,ACCESO) values (480,'AGALVIS',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (480,'VBRUN',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (480,'SHERRERA',1);
    */
?>
...
<form name="form1" action="cprenatal_rpt.php" method="POST">
    <div class="row">
        <div class="col">
