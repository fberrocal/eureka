...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
        ...
        values (540,3120,'Reporte de Teleorientación en Salud sin Contestar',50,'?r=teleosn',1);
        go
        SET IDENTITY_INSERT menu OFF;
        go

        insert into menud (MENUID,USUARIO,ACCESO) values (540,'AGALVIS',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (540,'VBRUN',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (540,'SHERRERA',1);
    */
?>

<div class="starter-template">
    <h3>Teleorientación Curso Pre_Maternidad sin Contestar</h3>
</div>
<form name="form1" action="telescur_rpt.php" method="POST">
    <div class="row">
        <div class="col">
