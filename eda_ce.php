...
<form name="form1" action="eda_ce_rpt.php" method="POST">
    <div class="row">
        <div class="col">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="edadini" id="edadini" min="0" max="180" value="0" required>
            </div>
        </div>
        <div class="col">
            <div class="form-group">
                <label for="edadfin">Edad Final:</label>
                <input type="number" class="form-control" name="edadfin" id="edadfin" min="0" max="180" value="180" required>
            </div>
        </div>
        <div class="col">
            <div class="form-group">
