...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
        ...
        values (550,3130,'Reporte Historia Clínica de Consulta Domiciliaria',50,'?r=hccdom',1);
        go
        SET IDENTITY_INSERT menu OFF;
        go

        insert into menud (MENUID,USUARIO,ACCESO) values (550,'AGALVIS',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (550,'VBRUN',1);
        insert into menud (MENUID,USUARIO,ACCESO) values (550,'SHERRERA',1);
        HISTORIA CLINICA DE CONSULTA DOMICILIARIA
    */
?>

<div class="starter-template">
    <h3>Reporte Historia Clínica de Consulta Domiciliaria</h3>
</div>
<form name="form1" action="hccdom_rpt.php" method="POST">
    <div class="row">
        <div class="col">
