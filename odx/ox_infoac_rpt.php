...
$columnas=array("TABLA","PRESTACIONID","CONSECUTIVO","ITEM","CODIGORIPS","ARCHIVORIPS","PYP","IDTERCEROFACT","CODSGSSS","IDADMINISTRADORA","RAZONSOCIAL","IDCONTRATANTE","IDPLAN",
                "N_FACTURA","IDAFILIADO","TIPO_DOC","DOCIDAFILIADO","EDADAFI","UNIDEDEDAD","FECHA","FINGRESO","NOAUTORIZACION","FEGRESO","IDSERVICIO","IDALTERNA","TIPOMED","TIPOSERVICIO",
                "DESCSERVICIO","NOMGENERICO","FORMA","CONCENTRACION","UMEDIDA","CANTIDAD","AMBITO","FINALIDAD","VIAINGRESO","PERSONALAT","IDDX","TIPODX","DXSALIDA","DX1","DX2","DX3",
                "COMPLICACION","FORMAREALIZACION","CAUSAEXT","CAUSAMUERTE","DESTINO","ESTADOSALIDA","VALOR","VALORCOPAGO","VALORITEM","VRNETO","ESTADOFACTURA","CAPITADO","CIRUGIA",
                "IDCIRUGIA","CONSECUTIVOCX","KCNTRID","TIPOSISTEMA","IDSEDE");
