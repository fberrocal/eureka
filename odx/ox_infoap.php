<?php
    ...
    */
    ...
    /* Query para la creación del ítem de menú en la base de datos
            ...
            values (760,3700,'Información Archivo AP de Odontología',30,'?r=./odx/ox_infoap',1);
            go
            SET IDENTITY_INSERT menu OFF;
            go

            insert into menud (MENUID,USUARIO,ACCESO) values (760,'AGALVIS',1);
            insert into menud (MENUID,USUARIO,ACCESO) values (760,'VBRUN',1);
    */
...
<div class="starter-template">
    <h3>Informaci&oacute;n archvio AP Odontología</h3>
</div>

<form name="form1" action="./odx/ox_infoap_rpt.php" method="POST">
