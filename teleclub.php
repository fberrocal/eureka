...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
		...
		values (510,3090,'Reporte de Teleconsultas Club Saludable',50,'?r=teleclub',1);
		go
		SET IDENTITY_INSERT menu OFF;
		go

		insert into menud (MENUID,USUARIO,ACCESO) values (510,'AGALVIS',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (510,'VBRUN',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (510,'SHERRERA',1);
    */
?>

<div class="starter-template">
    <h3>Reporte de Teleconsultas Club Saludable</h3>
</div>
<form name="form1" action="teleclub_rpt.php" method="POST">
    <div class="row">
        <div class="col">
