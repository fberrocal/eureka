...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
		...
		values (560,3140,'Reporte Historia de Seguimiento a casos de Covid-19',40,'?r=covid19',1);
		go
...
<div class="starter-template">
    <h3>Reporte Historia de Seguimiento a casos de Covid-19</h3>
</div>
<form name="form1" action="covid19_rpt.php" method="POST">
    <div class="row">
        <div class="col">
