...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
		...
		values (570,3150,'Reporte de Seguimiento diario a casos de Covid-19 (Detalle)',40,'?r=covidsd',1);
		go
		SET IDENTITY_INSERT menu OFF;
		go

		insert into menud (MENUID,USUARIO,ACCESO) values (560,'AGALVIS',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (560,'VBRUN',1);
		insert into menud (MENUID,USUARIO,ACCESO) values (560,'SHERRERA',1);
    */
?>

<div class="starter-template">
    <h3>Reporte de Seguimiento diario a casos de Covid-19 (Detalle)</h3>
</div>
<form name="form1" action="covidsd_rpt.php" method="POST">
    <div class="row">
        <div class="col">
