...
$result = $sth->fetchall(PDO::FETCH_ASSOC);
    ...
    /* Query para la creación del ítem de menú en la base de datos
        ...
        values (460,1870,'Atención Cardio-Cerebro-Vascular y Metabólica',10,'?r=hcardiov',1);
        go
        ...
        insert into menud (MENUID,USUARIO,ACCESO) values (460,'SHERRERA',1);
    */
?>

<div class="starter-template">
    <h3>Atenci&oacute;n Cardio-Cerebro-Vascular y Metab&oacute;lica</h3>
</div>
<form name="form1" action="hcardiov_rpt.php" method="POST">
    <div class="row">
        <div class="col">
