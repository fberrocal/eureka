<?php
    ...
    $plantilla='PRENATAL';                          // <-- Clase de Plantilla [Adulto Mayor]
    ...
    UNION ALL
    SELECT 'OCUPACION' AS CAMPO, 'OCUPACION' AS DESCCAMPO
    UNION ALL
    ...
    UNION ALL
    select CAMPO, DESCCAMPO from mpld where CLASEPLANTILLA='$plantilla' and CAMPO<>'Sexo' and CAMPO<>'EDAD' and ENREPORTE=1 and ltrim(rtrim(tipo_campo)) not in ('Titulo','Subtitulo')";
    ...
    */
    ...
    /*
    select CAMPO, DESCCAMPO from mpld where CLASEPLANTILLA='$plantilla' and CAMPO<>'Sexo' and CAMPO<>'EDAD' and IMPRIMIR=1 and ltrim(rtrim(tipo_campo)) not in ('Titulo','Subtitulo')";
    */
    ...
    */
    ...
    /*
    $qry = "SELECT CAMPO,DESCCAMPO FROM mpld WHERE CLASEPLANTILLA='$plantilla' and CAMPO<>'Sexo' and CAMPO<>'EDAD' and IMPRIMIR=1 and ltrim(rtrim(tipo_campo)) not in ('Titulo','Subtitulo')";
    */

    $qry = "SELECT CAMPO,DESCCAMPO FROM mpld WHERE CLASEPLANTILLA='$plantilla' and CAMPO<>'Sexo' and CAMPO<>'EDAD' and ENREPORTE=1 and ltrim(rtrim(tipo_campo)) not in ('Titulo','Subtitulo')";
