...
$columnas=array("SEDE","RAZONSOCIAL","FECHA_HC","TIPO_DOC","IDAFILIADO","PNOMBRE","SNOMBRE","PAPELLIDO","SAPELLIDO",
    "FNACIMIENTO","EDAD","DIRECCION","SEXO","TELEFONORES","GRUPOETNICO","DTSCONSULTA","FC","FR","TA","TALLA",
    "PESOACTUAL","PC","IMC","PESOEDADDE","PESOTALLADE","MENORDE7DIAS","TENDPESO","PCEF","DX1","DESDX1","REFERIRP",
    "ESPECIAL","PROGCITA","FECHACITA","RESUMEN");

$cabecera=array("SEDE","RAZONSOCIAL","FECHA","TIPO_DOC","IDAFILIADO","PNOMBRE","SNOMBRE","PAPELLIDO","SAPELLIDO",
    "FNACIMIENTO","EDAD","DIRECCION","SEXO","TELEFONO","GRUPOETNICO","Tipo de Consulta:","F. Cardiaca (/min):",
    "F. Respirat. (/min):","T. Arterial (mmHg):","Talla (Cms):","Peso actual (Gms):","P. Cefálico (Cms):",
    "Ind. Masa Corporal:","Indicadores de Peso/Edad (DE):","Indicadores de Peso/Talla (DE):",
    "Indicadores de Pérdida de peso:","Tendencia Peso:","P. Cefálico (Cms):","Dx Principal:","Diagnóstico",
...
$consulta="exec spV_HCA_Pivot '$fechaini','$fechafin','$plantilla','$idsede','[DTSCONSULTA],[FC],[FR],[TA],[TALLA],
[PESOACTUAL],[PC],[IMC],[PESOEDADDE],[PESOTALLADE],[MENORDE7DIAS],[TENDPESO],[PCEF],[DX1],[DESDX1],[REFERIRP],
[ESPECIAL],[PROGCITA],[FECHACITA],[RESUMEN]' ";
